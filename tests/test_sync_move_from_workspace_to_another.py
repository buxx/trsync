...
@scenario(
    "test_sync_move_from_workspace_to_another.feature",
    "Moved file from workspace to another what I own, when online, by syncing both",
)
...
def test_sync_move_from_workspace_to_another__when_offline__by_syncing_both():
    pass
